...
const create = asyncHandler(async (req, res) => {
  const result = await createRoute(req.body, req.user, buildRequestMeta(req));
...
const update = asyncHandler(async (req, res) => {
  const result = await updateRoute(req.params.id, req.body, req.user, buildRequestMeta(req));
...
const remove = asyncHandler(async (req, res) => {
  const result = await deleteRoute(req.params.id, req.user, buildRequestMeta(req));
